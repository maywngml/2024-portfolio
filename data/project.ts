...
export const projects: Project[] = [
  {
    ...
    details: [
      ...
      'Next.js 서버 컴포넌트를 최대한 활용하기 위해 컴포넌트를 세분화하여 코드의 재사용성과 유지보수성을 높였고, Plaiceholder를 사용해 이미지 크기와 블러 이미지를 사전 설정하는 이미지 서버 컴포넌트를 구현하여 레이아웃 시프트를 최소화하고 UX를 개선했습니다.',
      '이전 프로젝트에서의 경험을 바탕으로 Wagmi를 활용해 블록체인 지갑 연결 기능을 구현했으며, MongoDB와 Google APIs를 사용해 DAO 멤버 신청 기능을 개발했습니다. 또한, GSAP로 텍스트 슬라이드 인 애니메이션을 구현하고, 페이드 인과 바운스 애니메이션은 CSS로 구현했습니다.',
    ],
    achievements: [
      // TODO: 수정
  ...
  },
  {
    ...
    details: [
      ...
      '여러 트랜잭션이 처리되는 상황에서는 트랜잭션 순서를 철저히 관리했으며, API, 스마트 컨트랙트와 상호작용하는 과정에서 발생할 수 있는 다양한 에러 시나리오를 고려해 공통 에러 핸들링 로직을 구축하고, 사용자에게 적절한 공지를 제공했습니다.',
  ...
  },
  {
    ...
    details: [
      'APE UNIVERSE는 다양한 애니메이션을 통해 인터랙티브한 웹을 개발하는 데 중점을 두었습니다. GSAP를 활용하여 버튼 클릭 모션, 로켓 발사, 행성 이동 등의 애니메이션을 구현하여 웹에 생동감을 부여했습니다. 또한, 모든 사용자에게 일관된 경험을 제공하기 위해 애니메이션을 반응형으로 구현했습니다.',
  ...
  },
  {
    ...
    details: [
      ...
      'GSAP를 활용해 이미지 시퀀스 스크롤 애니메이션을 구현하고, ResizeObserver를 사용해 브라우저 화면 리사이징에 대응하여 모든 사용자에게 일관된 경험을 제공했습니다.',
