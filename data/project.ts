...
export const projects: Project[] = [
  {
    ...
    details: [
      ...
      '이전 프로젝트에서의 경험을 바탕으로 Wagmi를 활용하여 블록체인 지갑 연결 기능을 구현하고, MongoDB와 Google APIs를 사용해 DAO 멤버 신청 기능을 개발했습니다. 또한, GSAP을 통해 텍스트 슬라이드 인, 페이드 인, 바운스 등의 애니메이션을 효과적으로 구현했습니다.',
    ],
    achievements: [
  ...
  },
  {
    ...
    achievements: [
      '회사 소개, 채용 공고 등 다양한 정보를 한 곳에서 명확하게 제공함으로써 클라이언트와 지원자의 이해를 돕고 효율적인 커뮤니케이션 채널을 마련했습니다.',
    ],
  ...
  // },
  {
    ...
    details: [
      ...
      '초기에는 올해의 UI/UX 트렌드를 반영해 3D 에셋을 메인 요소로 사용하려 했으나, 3D 에셋과 어울리는 레이아웃을 구성하는 것이 쉽지 않아 컨셉을 변경했습니다. 작업하는 과정에서 즐거움을 느낄 수 있도록 귀엽고 따뜻한 컨셉을 메인으로 잡았으며, 메인 컬러로는 제가 좋아하는 보라색 계열을 선택했습니다. 메인 섹션에는 텍스트와 에셋에 애니메이션을 추가하여 귀여움을 더욱 강조했습니다.',
