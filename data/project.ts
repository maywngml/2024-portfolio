...
export const projects: Project[] = [
  {
    ...
    details: [
      '해당 프로젝트에서는 placeholder 이미지를 자동으로 제공하는 이미지 컴포넌트를 개발해 레이아웃 시프트 현상을 최소화하며 시각적 안정성을 향상했습니다. MongoDB와 Next.js API Routes를 사용해 멤버 목록 조회 API를 구현하고, 커서 기반 페이징을 적용하여 데이터 조회 성능을 최적화했습니다. 또한, ISR을 적용하여 멤버 상세 페이지의 최신 데이터를 주기적으로 반영하며 SSR 대비 성능을 개선했습니다.',
